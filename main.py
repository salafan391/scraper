...
class Scrap:
    columns = [ "اسم المتوفي",'النوع', 'الفئة العمرية','العمر', 'محل الإقامة',  'العنوان', 'تاريخ الوفاة','رقم هوية المتوفي','سبب الوفاة','الشهود','الشاهد الأول','رقم هوية الشاهد الأول','رقم تلفون الشاهد الأول','الشاهد الثاني','رقم هوية الشاهد الثاني','رقم تلفون الشاهد الثاني','حالة جسد المتوفى','اسم المبلغ','رقم هوية المبلغ ','رقم تليفون المبلغ',
      'جهة المبلغ','علاقته بالمتوفى','تصريح الدفن', 'الغسل','صلاة الجنازة', 'الدفن', 'النعى','النشر على الموقع','رقم التصريح', 'جهة التصريح', 'تاريخ التصريح','ملاحظات', 'المرفقات','إسم المغسلة','المغسل', 'مكان الغسل','عنوان الغسل', 'الموقع علي الخريطة','حالة الغسل','إسم المسجد','مكان المسجد','يوم', 'عقب صلاة','حالة الصلاة', 'إسم المقبرة',
       'مكان المقبرة', 'عنوان المقبرة', 'رقم الصف','رقم المربع','رقم القبر', 'تاريخ الدفن', 'اسم السيارة','نوع السيارة', 'السائق','مسار السيارة','النعى','رابط النعى']
    ...
    def combine_data(self):
        ...
        for i in self.combined_data:
            ...
            self.dict_data['النشر على الموقع'].append(i['الحالة'][16])
            ...
            self.dict_data['ملاحظات'].append(i.loc['ملاحظات'][1])
            ...
            self.dict_data['حالة الغسل'].append(i['الحالة'][13])
            ...
            self.dict_data['حالة الصلاة'].append(i[1][36])
            ...
            # self.dict_data['النعى'].append(i.loc['النعى'][1])
